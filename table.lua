...
"background[4,1;1,1;nothing.png]".. --texture transparente de fond
...
"image[3,1;1,1;macusa_arrow.png]"..
"image[5,1;1,1;macusa_arrow.png]"


minetest.register_node("macusa:table", {
	...
	on_construct = function(pos)
		macusa_construct(pos)
	end,
	on_receive_fields = function(pos, formname, fields, sender)
		macusa_fields(pos, _, fields, sender)
	end,
})

function macusa_construct(pos)
...
function macusa_fields(pos, _, fields, player)
	...
	if energy:get_name()=="default:mese_crystal" and src:get_name()=="macusa:basic_book" then
